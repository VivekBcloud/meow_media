    ...
    return (
        <div className="p-2 mt-2 bg-pc rounded-lg">
            ...
            <div className="">
                ...
                voluptatem ea consequatur in illum magnam. Lorem ipsum dolor sit
                amet consectetur adipisicing elit. Rerum voluptatem ea
                consequatur in illum magnam. voluptatem ea consequatur in illum
                magnam.
            </div>
        </div>
    );
